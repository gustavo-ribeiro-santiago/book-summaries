...
const BOOK_TITLE = 'AI Engineering: Building Applications with Foundation Models';
const SUMMARIES_DIR = path.join(__dirname, '..', '..', 'summaries', 'ai-engineering');

const chaptersMetadata = [
  { number: 1,  title: 'Chapter 1. Introduction to Building AI Applications with Foundation Models', file: 'chapter_01.md' },
  { number: 2,  title: 'Chapter 2. Understanding Foundation Models',                                 file: 'chapter_02.md' },
  { number: 3,  title: 'Chapter 3. Evaluation Methodology',                                          file: 'chapter_03.md' },
  { number: 4,  title: 'Chapter 4. Evaluate AI Systems',                                             file: 'chapter_04.md' },
  { number: 5,  title: 'Chapter 5. Prompt Engineering',                                              file: 'chapter_05.md' },
  { number: 6,  title: 'Chapter 6. RAG and Agents',                                                  file: 'chapter_06.md' },
  { number: 7,  title: 'Chapter 7. Finetuning',                                                      file: 'chapter_07.md' },
  { number: 8,  title: 'Chapter 8. Dataset Engineering',                                             file: 'chapter_08.md' },
  { number: 9,  title: 'Chapter 9. Inference Optimization',                                          file: 'chapter_09.md' },
  { number: 10, title: 'Chapter 10. AI Engineering Architecture and User Feedback',                  file: 'chapter_10.md' },
];
