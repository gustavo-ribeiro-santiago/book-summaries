...
const BOOK_TITLE = 'Flow: The Psychology of Optimal Experience';
const SUMMARIES_DIR = path.join(__dirname, '..', '..', 'summaries', 'flow');

const chaptersMetadata = [
  { number: 0,  title: 'PREFACE',                                          file: 'preface.md' },
  { number: 1,  title: 'HAPPINESS REVISITED',                              file: 'chapter_01.md' },
  { number: 2,  title: 'THE ANATOMY OF CONSCIOUSNESS',                     file: 'chapter_02.md' },
  { number: 3,  title: 'ENJOYMENT AND THE QUALITY OF LIFE',                file: 'chapter_03.md' },
  { number: 4,  title: 'THE CONDITIONS OF FLOW',                           file: 'chapter_04.md' },
  { number: 5,  title: 'THE BODY IN FLOW',                                 file: 'chapter_05.md' },
  { number: 6,  title: 'THE FLOW OF THOUGHT',                              file: 'chapter_06.md' },
  { number: 7,  title: 'WORK AS FLOW',                                     file: 'chapter_07.md' },
  { number: 8,  title: 'ENJOYING SOLITUDE AND OTHER PEOPLE',               file: 'chapter_08.md' },
  { number: 9,  title: 'CHEATING CHAOS',                                   file: 'chapter_09.md' },
  { number: 10, title: 'THE MAKING OF MEANING',                            file: 'chapter_10.md' },
];
...
async function createBook(userId, title) {
  ...
  return { id: docRef.id, title, author: 'Mihaly Csikszentmihalyi', userId };
}
