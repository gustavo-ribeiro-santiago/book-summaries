/**
 * Script to add all chapters of "Storytelling with Data" to Firestore
 * Reads chapter summaries from the summaries/swd folder
 *
 * Prerequisites:
 * 1. Install firebase-admin: npm install firebase-admin
 * 2. Download service account key from Firebase Console
 * 3. Save as "serviceAccountKey.json" in the scripts folder
 * 4. Run: node scripts/storytelling-with-data/add-all-chapters.js
 */
...
const BOOK_TITLE = 'Storytelling with Data';
const SUMMARIES_DIR = path.join(__dirname, '..', '..', 'summaries', 'swd');

const chaptersMetadata = [
  { number: 0,  title: 'INTRODUCTION',                      file: 'introduction.md' },
  { number: 1,  title: 'THE IMPORTANCE OF CONTEXT',         file: 'chapter_01.md' },
  { number: 2,  title: 'CHOOSING AN EFFECTIVE VISUAL',      file: 'chapter_02.md' },
  { number: 3,  title: 'CLUTTER IS YOUR ENEMY!',            file: 'chapter_03.md' },
  { number: 4,  title: "FOCUS YOUR AUDIENCE'S ATTENTION",   file: 'chapter_04.md' },
  { number: 5,  title: 'THINK LIKE A DESIGNER',             file: 'chapter_05.md' },
  { number: 6,  title: 'DISSECTING MODEL VISUALS',          file: 'chapter_06.md' },
  { number: 7,  title: 'LESSONS IN STORYTELLING',           file: 'chapter_07.md' },
  { number: 8,  title: 'PULLING IT ALL TOGETHER',           file: 'chapter_08.md' },
  { number: 9,  title: 'CASE STUDIES',                      file: 'chapter_09.md' },
  { number: 10, title: 'FINAL THOUGHTS',                    file: 'chapter_10.md' },
];
...
async function createBook(userId, title) {
  ...
  return { id: docRef.id, title, author: 'Cole Nussbaumer Knaflic', userId };
}
...
async function main() {
  try {
    console.log('📚 Storytelling with Data - Cole Nussbaumer Knaflic');
