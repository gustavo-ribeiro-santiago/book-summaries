/**
 * Script to add all chapters of "Designing Machine Learning Systems" to Firestore
 * Reads chapter summaries from the summaries/dmls folder
 *
 * Prerequisites:
 * 1. Install firebase-admin: npm install firebase-admin
 * 2. Download service account key from Firebase Console
 * 3. Save as "serviceAccountKey.json" in the scripts folder
 * 4. Run: node scripts/designing-ml-systems/add-all-chapters.js
 */
...
const BOOK_TITLE = 'Designing Machine Learning Systems';
const SUMMARIES_DIR = path.join(__dirname, '..', '..', 'summaries', 'dmls');

const chaptersMetadata = [
  { number: 0, title: 'PREFACE', file: 'preface.md' },
  { number: 1, title: 'OVERVIEW OF MACHINE LEARNING SYSTEMS', file: 'chapter_01.md' },
  { number: 2, title: 'INTRODUCTION TO MACHINE LEARNING SYSTEMS DESIGN', file: 'chapter_02.md' },
  { number: 3, title: 'DATA ENGINEERING FUNDAMENTALS', file: 'chapter_03.md' },
  { number: 4, title: 'TRAINING DATA', file: 'chapter_04.md' },
  { number: 5, title: 'FEATURE ENGINEERING', file: 'chapter_05.md' },
  { number: 6, title: 'MODEL DEVELOPMENT AND OFFLINE EVALUATION', file: 'chapter_06.md' },
  { number: 7, title: 'MODEL DEPLOYMENT AND PREDICTION SERVICE', file: 'chapter_07.md' },
  { number: 8, title: 'DATA DISTRIBUTION SHIFTS AND MONITORING', file: 'chapter_08.md' },
  { number: 9, title: 'CONTINUAL LEARNING AND TEST IN PRODUCTION', file: 'chapter_09.md' },
  { number: 10, title: 'INFRASTRUCTURE AND TOOLING FOR MLOPS', file: 'chapter_10.md' },
  { number: 11, title: 'THE HUMAN SIDE OF MACHINE LEARNING', file: 'chapter_11.md' },
];
...
async function createBook(userId, title) {
  ...
  return { id: docRef.id, title, author: 'Chip Huyen', userId };
}
...
async function main() {
  try {
    console.log('📚 Designing Machine Learning Systems - Chip Huyen');
